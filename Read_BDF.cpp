...
if (file_data == 0){
	...
	cout << "The file has not been opened. Check that the name of the file is correct and make sure to include the extension bdf";
	
}

else{
	
	cout << "The file has been opened correctly\n";
